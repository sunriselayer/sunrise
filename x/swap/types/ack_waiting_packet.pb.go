...
type AckWaitingPacket_InFlightIndexReturn struct {
	InFlightIndexReturn *PacketIndex `protobuf:"bytes,8,opt,name=in_flight_index_return,json=inFlightIndexReturn,proto3,oneof" json:"in_flight_index_return,omitempty"`
}
...
type AckWaitingPacket_InFlightIndexForward struct {
	InFlightIndexForward *PacketIndex `protobuf:"bytes,10,opt,name=in_flight_index_forward,json=inFlightIndexForward,proto3,oneof" json:"in_flight_index_forward,omitempty"`
}
...
func (m *AckWaitingPacket) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *AckWaitingPacket) GetSrcPortId() string {
	if m != nil {
		return m.SrcPortId
	}
	return ""
...
func (m *AckWaitingPacket) GetSrcChannelId() string {
	if m != nil {
...
var fileDescriptor_b77dedc1ff7dee64 = []byte{
	...
	,
}
...
func (m *AckWaitingPacket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Data) > 0 {
		i -= len(m.Data)
		copy(dAtA[i:], m.Data)
		i = encodeVarintAckWaitingPacket(dAtA, i, uint64(len(m.Data)))
		i--
		dAtA[i] = 0x12
	}
	{
