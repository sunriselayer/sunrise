...
type FeeAllowance struct {
	Gas    cosmossdk_io_math.Int `protobuf:"bytes,1,opt,name=gas,proto3,customtype=cosmossdk.io/math.Int" json:"gas"`
	Expiry time.Time             `protobuf:"bytes,2,opt,name=expiry,proto3,stdtime" json:"expiry"`
}
...
func (*FeeAllowance) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ef62ed4cb7da71d, []int{0}
}
...
func (m *FeeAllowance) GetExpiry() time.Time {
	if m != nil {
		return m.Expiry
	}
	return time.Time{}
...
func init() {
	proto.RegisterType((*FeeAllowance)(nil), "sunrise.blobgrant.v1.FeeAllowance")
}

func init() {
	proto.RegisterFile("sunrise/blobgrant/v1/allowance.proto", fileDescriptor_6ef62ed4cb7da71d)
}

var fileDescriptor_6ef62ed4cb7da71d = []byte{
	...
	,
}
...
func (m *FeeAllowance) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n1
	i = encodeVarintAllowance(dAtA, i, uint64(n1))
	i--
	dAtA[i] = 0x12
	{
		size := m.Gas.Size()
