...
func (m *Registration) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
var fileDescriptor_89d0f6d3a26735d8 = []byte{
	...
	0xca, 0x2f, 0xc9, 0x17, 0x12, 0x81, 0x2a, 0xd4, 0x83, 0x2b, 0xd4, 0x2b, 0x33, 0x54, 0x4a, 0xe3,
	0xe2, 0x09, 0x42, 0x52, 0x2b, 0x24, 0xc1, 0xc5, 0x9e, 0x98, 0x92, 0x52, 0x94, 0x5a, 0x5c, 0x2c,
	0xc1, 0xa8, 0xc0, 0xa8, 0xc1, 0x19, 0x04, 0xe3, 0x0a, 0x29, 0x71, 0xf1, 0x14, 0x14, 0xe5, 0x57,
	0x54, 0x3a, 0x42, 0xa5, 0x99, 0xc0, 0xd2, 0x28, 0x62, 0x20, 0xdd, 0xc9, 0x45, 0xa9, 0x89, 0x25,
	0xf9, 0x45, 0x12, 0xcc, 0x10, 0xdd, 0x50, 0xae, 0x93, 0xff, 0x89, 0x47, 0x72, 0x8c, 0x17, 0x1e,
	...
	0x43, 0x9d, 0x98, 0x93, 0x58, 0x99, 0x5a, 0x04, 0xe3, 0xe8, 0x26, 0x16, 0x14, 0xe8, 0x57, 0x20,
	0x79, 0xaf, 0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0xec, 0x2b, 0x63, 0x40, 0x00, 0x00, 0x00,
	0xff, 0xff, 0xf4, 0x21, 0x80, 0x8b, 0x00, 0x01, 0x00, 0x00,
}
...
func (m *Registration) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintRegistration(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x1a
	}
