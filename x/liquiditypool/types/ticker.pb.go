...
type TickInfo struct {
	...
	UptimeTrackers UptimeTrackers                              `protobuf:"bytes,6,opt,name=uptime_trackers,json=uptimeTrackers,proto3" json:"uptime_trackers" yaml:"uptime_trackers"`
}
...
type UptimeTrackers struct {
	List []UptimeTracker `protobuf:"bytes,1,rep,name=list,proto3" json:"list"`
}
...
func (*UptimeTrackers) Descriptor() ([]byte, []int) {
	return fileDescriptor_675149ba84fd9eb6, []int{1}
}
...
func (*UptimeTracker) Descriptor() ([]byte, []int) {
	return fileDescriptor_675149ba84fd9eb6, []int{2}
}
...
func init() {
	...
	proto.RegisterType((*UptimeTrackers)(nil), "sunrise.liquiditypool.UptimeTrackers")
	proto.RegisterType((*UptimeTracker)(nil), "sunrise.liquiditypool.UptimeTracker")
}
...
var fileDescriptor_675149ba84fd9eb6 = []byte{
	...
	,
}
