...
func (m *MockStakingKeeper) IterateBondedValidatorsByPower(arg0 context.Context, arg1 func(int64, types0.Validator) bool) error {
	m.ctrl.T.Helper()
...
func (m *MockStakingKeeper) IterateDelegations(ctx context.Context, delegator types.AccAddress, fn func(int64, types0.Delegation) bool) error {
	m.ctrl.T.Helper()
