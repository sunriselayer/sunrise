...
//
//	mockgen -source=x/liquidityincentive/types/expected_keepers.go -destination=x/liquidityincentive/testutil/expected_keepers_mocks.go -package=testutil
//
...
import (
	...
	types2 "github.com/sunriselayer/sunrise/x/tokenconverter/types"
...
func (m *MockTokenConverterKeeper) GetParams(ctx context.Context) (types2.Params, error) {
	m.ctrl.T.Helper()
...
func (mr *MockLiquidityPoolKeeperMockRecorder) AllocateIncentive(ctx, poolId, sender, incentiveCoins any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
