...
var (
	...
	pattern_Query_Vote_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"sunrise", "liquidityincentive", "votes", "address"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Votes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"sunrise", "liquidityincentive", "votes"}, "", runtime.AssumeColonVerbOpt(false)))
)
