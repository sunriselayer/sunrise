...
type ShardAvailability struct {
	ShardIndex   *ShardIndex `protobuf:"bytes,1,opt,name=shard_index,json=shardIndex,proto3" json:"shard_index,omitempty"`
...
func (m *ShardAvailability) GetShardIndex() *ShardIndex {
	if m != nil {
		return m.ShardIndex
	}
	return nil
...
type MsgChallengeUnavailability struct {
	...
	ShardIndex       *ShardIndex `protobuf:"bytes,3,opt,name=shard_index,json=shardIndex,proto3" json:"shard_index,omitempty"`
	// [0, 64)
...
func (m *MsgChallengeUnavailability) GetShardIndex() *ShardIndex {
	if m != nil {
		return m.ShardIndex
	}
	return nil
...
var fileDescriptor_8776d5690e46d2ba = []byte{
	...
	,
}
