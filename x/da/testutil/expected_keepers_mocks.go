...
//
//	mockgen -source=x/da/types/expected_keepers.go -destination=x/da/testutil/expected_keepers_mocks.go -package=testutil
//
...
func (m *MockStakingKeeper) Validator(ctx context.Context, arg1 types.ValAddress) (types0.ValidatorI, error) {
	m.ctrl.T.Helper()
