// https://github.com/cosmos/cosmos-sdk/blob/v0.53.0-rc.4/x/auth/ante/fee.go
package ante
...
func NewDeductFeeDecorator(ak AccountKeeper, bk types.BankKeeper, fk FeegrantKeeper, feeKeeper *feekeeper.Keeper) DeductFeeDecorator {
