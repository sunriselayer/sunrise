...
const (
	Msg_UpdateParams_FullMethodName       = "/sunrise.blobstream.v1.Msg/UpdateParams"
	Msg_RegisterEvmAddress_FullMethodName = "/sunrise.blobstream.v1.Msg/RegisterEvmAddress"
)
...
func (c *msgClient) RegisterEvmAddress(ctx context.Context, in *MsgRegisterEvmAddress, opts ...grpc.CallOption) (*MsgRegisterEvmAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_RegisterEvmAddress_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) RegisterEvmAddress(context.Context, *MsgRegisterEvmAddress) (*MsgRegisterEvmAddressResponse, error) {
...
func _Msg_RegisterEvmAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_RegisterEvmAddress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
