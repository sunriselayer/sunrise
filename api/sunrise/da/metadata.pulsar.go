...
var (
	md_MetadataUriWrapper              protoreflect.MessageDescriptor
	fd_MetadataUriWrapper_metadata_uri protoreflect.FieldDescriptor
)

func init() {
	file_sunrise_da_metadata_proto_init()
	md_MetadataUriWrapper = File_sunrise_da_metadata_proto.Messages().ByName("MetadataUriWrapper")
	fd_MetadataUriWrapper_metadata_uri = md_MetadataUriWrapper.Fields().ByName("metadata_uri")
}

var _ protoreflect.Message = (*fastReflection_MetadataUriWrapper)(nil)

type fastReflection_MetadataUriWrapper MetadataUriWrapper

func (x *MetadataUriWrapper) ProtoReflect() protoreflect.Message {
	return (*fastReflection_MetadataUriWrapper)(x)
}

func (x *MetadataUriWrapper) slowProtoReflect() protoreflect.Message {
	mi := &file_sunrise_da_metadata_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_MetadataUriWrapper_messageType fastReflection_MetadataUriWrapper_messageType
var _ protoreflect.MessageType = fastReflection_MetadataUriWrapper_messageType{}

type fastReflection_MetadataUriWrapper_messageType struct{}

func (x fastReflection_MetadataUriWrapper_messageType) Zero() protoreflect.Message {
	return (*fastReflection_MetadataUriWrapper)(nil)
}
func (x fastReflection_MetadataUriWrapper_messageType) New() protoreflect.Message {
	return new(fastReflection_MetadataUriWrapper)
}
func (x fastReflection_MetadataUriWrapper_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_MetadataUriWrapper
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_MetadataUriWrapper) Descriptor() protoreflect.MessageDescriptor {
	return md_MetadataUriWrapper
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_MetadataUriWrapper) Type() protoreflect.MessageType {
	return _fastReflection_MetadataUriWrapper_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_MetadataUriWrapper) New() protoreflect.Message {
	return new(fastReflection_MetadataUriWrapper)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_MetadataUriWrapper) Interface() protoreflect.ProtoMessage {
	return (*MetadataUriWrapper)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_MetadataUriWrapper) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.MetadataUri != "" {
		value := protoreflect.ValueOfString(x.MetadataUri)
		if !f(fd_MetadataUriWrapper_metadata_uri, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_MetadataUriWrapper) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sunrise.da.MetadataUriWrapper.metadata_uri":
		return x.MetadataUri != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sunrise.da.MetadataUriWrapper"))
		}
		panic(fmt.Errorf("message sunrise.da.MetadataUriWrapper does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MetadataUriWrapper) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "sunrise.da.MetadataUriWrapper.metadata_uri":
		x.MetadataUri = ""
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_MetadataUriWrapper) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "sunrise.da.MetadataUriWrapper.metadata_uri":
		value := x.MetadataUri
	...
	default:
		...
		panic(fmt.Errorf("message sunrise.da.MetadataUriWrapper does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MetadataUriWrapper) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "sunrise.da.MetadataUriWrapper.metadata_uri":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MetadataUriWrapper) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sunrise.da.MetadataUriWrapper.metadata_uri":
		panic(fmt.Errorf("field metadata_uri of message sunrise.da.MetadataUriWrapper is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sunrise.da.MetadataUriWrapper"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_MetadataUriWrapper) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sunrise.da.MetadataUriWrapper.metadata_uri":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_MetadataUriWrapper) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sunrise.da.MetadataUriWrapper", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_MetadataUriWrapper) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_MetadataUriWrapper) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_MetadataUriWrapper) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_MetadataUriWrapper) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*MetadataUriWrapper)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MetadataUriWrapper: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: MetadataUriWrapper: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *MetadataUriWrapper) Reset() {
	*x = MetadataUriWrapper{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sunrise_da_metadata_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *MetadataUriWrapper) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MetadataUriWrapper) ProtoMessage() {}

// Deprecated: Use MetadataUriWrapper.ProtoReflect.Descriptor instead.
func (*MetadataUriWrapper) Descriptor() ([]byte, []int) {
	return file_sunrise_da_metadata_proto_rawDescGZIP(), []int{1}
}

func (x *MetadataUriWrapper) GetMetadataUri() string {
	if x != nil {
		return x.MetadataUri
	}
	return ""
...
var file_sunrise_da_metadata_proto_rawDesc = []byte{
	...
	,
...
var file_sunrise_da_metadata_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_sunrise_da_metadata_proto_goTypes = []interface{}{
	(*Metadata)(nil),           // 0: sunrise.da.Metadata
	(*MetadataUriWrapper)(nil), // 1: sunrise.da.MetadataUriWrapper
}
...
func file_sunrise_da_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sunrise_da_metadata_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MetadataUriWrapper); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
