...
func (x *fastReflection_Route) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "sunrise.swap.Route.pool":
		if x.Type == nil {
			return false
		} else if _, ok := x.Type.(*Route_Pool); ok {
			return true
		} else {
			return false
		}
	case "sunrise.swap.Route.series":
		if x.Type == nil {
			return false
		} else if _, ok := x.Type.(*Route_Series); ok {
			return true
		} else {
			return false
		}
	case "sunrise.swap.Route.parallel":
		if x.Type == nil {
			return false
		} else if _, ok := x.Type.(*Route_Parallel); ok {
			return true
		} else {
			return false
		}
...
func (x *fastReflection_Route) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "sunrise.swap.Route.pool":
		...
		} else if v, ok := x.Type.(*Route_Pool); ok {
	...
	case "sunrise.swap.Route.series":
		...
		} else if v, ok := x.Type.(*Route_Series); ok {
	...
	case "sunrise.swap.Route.parallel":
		...
		} else if v, ok := x.Type.(*Route_Parallel); ok {
...
func (x *fastReflection_Route) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "sunrise.swap.Route.pool":
		...
		x.Type = &Route_Pool{Pool: cv}
	case "sunrise.swap.Route.series":
		cv := value.Message().Interface().(*RouteSeries)
		x.Type = &Route_Series{Series: cv}
	case "sunrise.swap.Route.parallel":
		cv := value.Message().Interface().(*RouteParallel)
		x.Type = &Route_Parallel{Parallel: cv}
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sunrise.swap.Route"))
		}
...
func (x *Route) GetType() isRoute_Type {
	if x != nil {
		return x.Type
	}
	return nil
...
func (x *Route) GetPool() *RoutePool {
	if x, ok := x.GetType().(*Route_Pool); ok {
		return x.Pool
	}
	return nil
}
...
func (x *Route) GetSeries() *RouteSeries {
	if x, ok := x.GetType().(*Route_Series); ok {
		return x.Series
	}
	return nil
}
...
func (x *Route) GetParallel() *RouteParallel {
	if x, ok := x.GetType().(*Route_Parallel); ok {
		return x.Parallel
	}
	return nil
}
...
var file_sunrise_swap_route_proto_rawDesc = []byte{
	...
	0x22, 0xe6, 0x01, 0x0a, 0x05, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x64, 0x65,
	...
	0x6c, 0x42, 0x06, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x24, 0x0a, 0x09, 0x52, 0x6f, 0x75,
	...
	0x45, 0x0a, 0x0b, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x53, 0x65, 0x72, 0x69, 0x65, 0x73, 0x12, 0x36,
	...
	,
	...
	0x01, 0x52, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x34, 0x0a, 0x05, 0x72, 0x6f, 0x75,
	0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73, 0x75, 0x6e, 0x72, 0x69,
	0x73, 0x65, 0x2e, 0x73, 0x77, 0x61, 0x70, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x42, 0x09, 0xc8,
	0xde, 0x1f, 0x00, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x05, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x42,
	0x8e, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x75, 0x6e, 0x72, 0x69, 0x73, 0x65, 0x2e,
	0x73, 0x77, 0x61, 0x70, 0x42, 0x0a, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f,
