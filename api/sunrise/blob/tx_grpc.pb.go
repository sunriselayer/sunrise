...
const (
	Msg_UpdateParams_FullMethodName = "/sunrise.blob.Msg/UpdateParams"
	Msg_PayForBlobs_FullMethodName  = "/sunrise.blob.Msg/PayForBlobs"
)
...
func (c *msgClient) PayForBlobs(ctx context.Context, in *MsgPayForBlobs, opts ...grpc.CallOption) (*MsgPayForBlobsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_PayForBlobs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_PayForBlobs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_PayForBlobs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
